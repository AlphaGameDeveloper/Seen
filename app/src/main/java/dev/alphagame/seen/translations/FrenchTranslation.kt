...
class FrenchTranslation : Translation() {
    ...
    override val resultMild = "Se sentir un peu déprimé"
    override val resultModerate = "Se sentir déprimé"
    override val resultSevere = "Vraiment en difficulté"
    ...
    override val deletePHQ9ResponsesTitle = "Supprimer les réponses PHQ-9"
    override val phq9SeverityMinimal = "Dépression minimale"
    override val phq9SeverityMild = "Dépression légère"
    override val phq9SeverityModerate = "Avoir du mal"
    override val phq9SeverityModeratelySevere = "Avoir du mal"
    override val phq9SeveritySevere = "Dépression sévère"
    override val phq9SeverityUnknown = "Inconnu"
    override val deletePHQ9EntryTitle = "Supprimer l'entrée PHQ9 ?"
    override val deletePHQ9EntryDescription = "Supprimer le résultat PHQ-9 avec un score de %s du %s ?\n\nLes données supprimées ne peuvent pas être récupérées."
    override val deletePHQ9EntryConfirm = "Supprimer"
    override val deletePHQ9EntryCancel = "Annuler"
    override val deletePHQ9EntryContentDescription = "Supprimer l'entrée PHQ-9"
    ...
    // AI Analysis & Results
    override val aiAnalysisInProgress = "Aperçu de l'IA en cours..."
    override val aiAnalysisReady = "Aperçu de l'IA prête ! Tapez ci-dessous pour voir les perspectives."
    override val aiAnalysisUnavailable = "Aperçu de l'IA indisponible. Voir les ressources de base à la place."
    override val preparingAiAnalysis = "Préparation de l'aperçu de l'IA..."
    override val viewAiAnalysis = "Voir l'aperçu de l'IA"
    override val viewResourcesAndSupport = "Voir les ressources et le support"

    override val backToResults2 = "Retour aux résultats"
    override val aiAnalysis = "Aperçu de l'IA"
    override val score2 = "Score"
    override val level = "Niveau"
    override val incompleteAnalysis = "Aperçu Incomplète"
    override val incompleteAnalysisDescription = "L'Aperçu par l'IA a été reçue mais certaines données manquaient."
    override val noAnalysisData = "Aucune donnée d'aperçu"
    override val noAnalysisDataDescription = "L'aperçu par IA est terminée mais aucune donnée n'a été reçue."
    override val analysisUnavailable = "Aperçu indisponible"
    override val viewSupport = "Voir des ressources supplémentaires"
    override val aiIsAnalyzing = "L'IA Aperçu vos réponses..."
    override val mayTakeABit = "Cela peut prendre quelques instants"
    override val youCanStillViewResources = "Vous pouvez toujours consulter des ressources utiles et des informations de soutien en utilisant le bouton ci-dessous."

    override val emotionalStateAnalysis = "Aperçu de l'état émotionnel"
    override val recomendations = "Recommandations"
    override val goals = "Objectifs"
    override val disclaimer = "⚠\uFE0F Cette aperçu par IA est uniquement à des fins d'information et ne doit pas remplacer les conseils médicaux professionnels. Veuillez consulter un professionnel de santé pour un diagnostic et un traitement appropriés."
    ...
    override val severeSymptoms = "Vos réponses indiquent des symptômes graves. Une aide professionnelle est fortement recommandée."
    override val about988 = "Environ 988"
    override val aboutDepression = "À propos de la dépression"
    override val aboutDepressionDescription = "Il est important de comprendre ce que vous ressentez, même si vous n'avez pas de symptômes graves. Voici quelques ressources sur le sujet de la dépression."
    override val learnAboutDepression2 = "En savoir plus sur la dépression"
    override val caringForMentalHealth = "Prendre soin de votre santé mentale"
    override val recommendedResources = "Ressources recommandées"
    override val recommendedResourcesDescription = "Les ressources suivantes sont recommandées en fonction de vos réponses au PHQ-9."
    override val aboutLosingInterest = "À propos de perdre de l'intérêt"
    override val aboutSadness = "À propos de la tristesse/du désespoir"
    override val aboutSleep = "À propos du sommeil/de la fatigue"
    override val aboutFeelingBad = "À propos de se sentir mal dans sa peau"
    override val aboutConcentration = "À propos des problèmes de concentration"
    override val additionalYouthResources = "Ressources supplémentaires pour les jeunes"
    override val wellnessResources = "Trouvez un centre de bien-être local"
    ...
    override val deletePHQ9Result = "Supprimer le résultat PHQ-9 avec le score %s de %s?\\n\\nLes données supprimées ne peuvent pas être récupérées."
