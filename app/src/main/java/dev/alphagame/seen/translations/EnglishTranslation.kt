...
class EnglishTranslation : Translation() {
    ...
    // Encryption Settings
    override val encryptionAndSecurity = "Encryption & Security"
    override val encryptDatabase = "Encrypt Database"
    override val encryptDatabaseDescription = "Protect your data with PIN-based encryption. All notes and assessment results will be encrypted."
    override val setupEncryption = "Set Up Encryption"
    override val disableEncryption = "Disable Encryption"
    override val changePin = "Change PIN"
    override val enterCurrentPin = "Enter Current PIN"
    override val enterNewPin = "Enter New PIN"
    override val confirmNewPin = "Confirm New PIN"
    override val pinSetupTitle = "Set Up Database Encryption"
    override val pinSetupMessage = "Choose a 4-6 digit PIN to encrypt your database. You'll need to enter this PIN each time you open the app."
    override val pinChangeTitle = "Change Encryption PIN"
    override val pinChangeMessage = "Enter your current PIN, then choose a new 4-6 digit PIN."
    override val pinVerifyTitle = "Enter PIN"
    override val pinVerifyMessage = "Enter your PIN to access encrypted data."
    override val encryptionEnabled = "Encryption: Enabled"
    override val encryptionDisabled = "Encryption: Disabled"
    override val incorrectPin = "Incorrect PIN"
    override val pinChangedSuccessfully = "PIN changed successfully"
    override val encryptionSetupSuccess = "Encryption enabled successfully"
    override val encryptionDisabledSuccess = "Encryption disabled successfully"
    override val disableEncryptionWarning = "Disabling encryption will make your data unencrypted. Are you sure?"
}
