...
class SpanishTranslation : Translation() {
    ...
    override val resultMild = "Sintiendo bien"
    override val resultModerate = "Sintiéndome un poco decaído"
    override val resultSevere = "Realmente luchando"
    ...
    override val saveNote = "💾 Guardar nota"
        override val deleteNoteDialogText = "El %s escribiste \"%s\"\n\nLas notas eliminadas no se pueden recuperar."
    ...
    override val phq9SeverityModerate = "Teniendo un momento difícil"
    override val phq9SeverityModeratelySevere = "Teniendo un momento difícil"
    ...
    // AI Analysis & Results
    override val aiAnalysisInProgress = "Resumen de IA en progreso..."
    override val aiAnalysisReady = "¡Resumen de IA listo! Toca abajo para ver las perspectivas."
    override val aiAnalysisUnavailable = "Resumen de IA no disponible. Ve recursos básicos en su lugar."
    override val preparingAiAnalysis = "Preparando resumen de IA..."
    override val viewAiAnalysis = "Ver resumen de IA"
    override val viewResourcesAndSupport = "Ver recursos y apoyo"

    override val backToResults2 = "Volver a los resultados"
    override val aiAnalysis = "Resumen de IA"
    override val score2 = "Puntuación"
    override val level = "Nivel"
    override val incompleteAnalysis = "Resumen Incompleto"
    override val incompleteAnalysisDescription = "Se recibió el resumen de IA, pero faltaban algunos datos."
    override val noAnalysisData = "Sin datos de resumen"
    override val noAnalysisDataDescription = "El resumen de IA se completó, pero no se recibieron datos."
    override val analysisUnavailable = "Resumen no disponible"
    override val viewSupport = "Ver Recursos Adicionales"
    override val aiIsAnalyzing = "La IA está revisando tus respuestas..."
    ...
    override val emotionalStateAnalysis = "Resumen del Estado Emocional"
    override val recomendations = "Recomendaciones"
    override val goals = "Objetivos"
    override val disclaimer = "⚠\uFE0F Este resumen de IA es solo con fines informativos y no debe reemplazar el consejo médico profesional. Por favor, consulte con un proveedor de atención médica para un diagnóstico y tratamiento adecuados."
    ...
    override val severeSymptoms = "Tus respuestas indican síntomas graves. Se recomienda encarecidamente buscar ayuda profesional."
    override val about988 = "Alrededor de 988"
    override val aboutDepression = "Acerca de la depresión"
    override val aboutDepressionDescription = "Es importante comprender cómo te sientes, incluso si no tienes síntomas graves. Aquí hay algunos recursos sobre el tema de la depresión."
    override val learnAboutDepression2 = "Aprende sobre la depresión"
    override val caringForMentalHealth = "Cuidando de tu salud mental"
    override val recommendedResources = "Recursos recomendados"
    override val recommendedResourcesDescription = "Se recomiendan los siguientes recursos según sus respuestas al PHQ-9."
    override val aboutLosingInterest = "Sobre perder el interés"
    override val aboutSadness = "Acerca de la tristeza/la desesperanza"
    override val aboutSleep = "Acerca del Sueño/Cansancio"
