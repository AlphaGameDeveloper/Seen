...
class SpanishTranslation : Translation() {
    ...
    // Encryption Settings
    override val encryptionAndSecurity = "Cifrado y seguridad"
    override val encryptDatabase = "Cifrar base de datos"
    override val encryptDatabaseDescription = "Protege tus datos con cifrado basado en PIN. Todas las notas y resultados de evaluación serán cifrados."
    override val setupEncryption = "Configurar cifrado"
    override val disableEncryption = "Desactivar cifrado"
    override val changePin = "Cambiar PIN"
    override val enterCurrentPin = "Ingresa PIN actual"
    override val enterNewPin = "Ingresa nuevo PIN"
    override val confirmNewPin = "Confirma nuevo PIN"
    override val pinSetupTitle = "Configurar cifrado de base de datos"
    override val pinSetupMessage = "Elige un PIN de 4-6 dígitos para cifrar tu base de datos. Necesitarás ingresar este PIN cada vez que abras la aplicación."
    override val pinChangeTitle = "Cambiar PIN de cifrado"
    override val pinChangeMessage = "Ingresa tu PIN actual, luego elige un nuevo PIN de 4-6 dígitos."
    override val pinVerifyTitle = "Ingresar PIN"
    override val pinVerifyMessage = "Ingresa tu PIN para acceder a los datos cifrados."
    override val encryptionEnabled = "Cifrado: Activado"
    override val encryptionDisabled = "Cifrado: Desactivado"
    override val incorrectPin = "PIN incorrecto"
    override val pinChangedSuccessfully = "PIN cambiado exitosamente"
    override val encryptionSetupSuccess = "Cifrado activado exitosamente"
    override val encryptionDisabledSuccess = "Cifrado desactivado exitosamente"
    override val disableEncryptionWarning = "Desactivar el cifrado hará que tus datos no estén cifrados. ¿Estás seguro?"
}
